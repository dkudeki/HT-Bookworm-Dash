...
def print_hover_data(clickData, group):
    if clickData:
        ...
        map_to_ld = {
            ...
            "htsource": {
                "University of Michigan (MIU)": "MIU",
                "UC Northern Regional Library Facility (NRLF)": "NRLF",
                "Harvard University (HVD)": "HVD",
                "University of Illinois at Urbana-Champaign (UIUC)": "UIUC",
                "University of Minnesota (UMN)": "UMN",
                "University of Virginia (UVA)": "UVA",
                "Cornell University (COO)": "COO",
                "University of Wisconsin (WU)": "WU",
                "Indiana University (INU)": "INU",
                "University of California, San Diego (UCSD)": "UCSD",
                "University of Texas, Austin (TXU)": "TXU",
                "Pennsylvania State University (PST)": "PST",
                "New York Public Library (NYP)": "NYP",
                "The Ohio State University (OSU)": "OSU",
                "Princeton University (NJP)": "NJP",
                "University of California, Los Angeles (UCLA)": "UCLA",
                "University of California, Santa Cruz (UCSC)": "UCSC",
                "University of California, Berkeley (UCBK)": "UCBK",
                "Northwestern University (NWU)": "NWU",
                "UC Southern Regional Library Facility (SRLF)": "SRLF",
                "University of California, Riverside (UCR)": "UCR",
                "University of Chicago (CHI)": "CHI",
                "Universidad de Complutense de Madrid (UCM)": "UCM",
                "Library of Congress (ILOC)": "ILOC",
                "Columbia University (NNC)": "NNC",
                "UC Southern Regional Library Facility (ISRLF)": "ISRLF",
                "Keio University (KEIO)": "KEIO",
                "University of Illinois at Urbana-Champaign (IUIUC)": "IUIUC",
                "INRLF": "INRLF",
                "Michigan State University (MSU)": "MSU",
                "University of Alberta (AEU)": "AEU",
                "IAU": "University of Iowa (IAU)",
                "GWLA": "GWLA",
                "GRI": "GRI",
                "Purdue University (PUR)": "PUR",
                "University of California, Davis (UCD)": "UCD",
                "University of North Carolina at Chapel Hill (IUNC)": "IUNC",
                "Columbia University (INNC)": "INNC",
                "Yale University (YALE)": "YALE",
                "University of Massachusetts Amherst (MU)": "MU",
                "Duke University (IDUKE)": "IDUKE",
                "UCI": "UCI",
                "University of Florida (IUFL)": "IUFL",
                "University of Illinois at Urbana-Champaign (UIUCL)": "UIUCL",
                "Boston College (IBC)": "IBC",
                "Texas A&M University (TXCM)": "TXCM",
                "UMDB": "UMDB",
                "University of Connecticut (CTU)": "CTU",
                "University of California, Davis (IUCD)": "IUCD",
                "North Carolina State University (INCSU)": "INCSU",
                "University of California, San Francisco (UCSF)": "UCSF",
                "Emory University (GEU)": "GEU",
                "Pennsylvania State University (IPST)": "IPST",
                "University of Missouri, Columbia (MOU)": "MOU",
                "Wake Forest University (NCWSW)": "NCWSW",
                "Tufts University (MMET)": "MMET",
                "McGill University (QMM)":"QMM",
                "University of California, Santa Barbara (UCSB)": "UCSB",
                "UMLAW": "UMLAW",
                "University of Maryland (MDU)": "MDU",
                "University of Washington (WAU)": "WAU",
                "UMBUS": "UMBUS",
                "University of California, Los Angeles (IUCLA)": "IUCLA",
                "American University of Beirut (LEBAU)": "LEBAU",
                "University of Florida (UFDC)": "UFDC",
                "Arizona State University (AZTES)": "AZTES",
                "University of Miami (FMU)": "FMU",
                "Clark Art Institute (MWICA)": "MWICA",
                "University of Pennsylvania, Van Pelt-Dietrich Library (PU)": "PU",
                "University of Queensland, Saint Lucia (AUBRU)": "AUBRU"
            }
        }
        logging.debug(group)
